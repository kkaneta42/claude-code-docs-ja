...
[チーム外の他の Claude Code セッション](/docs/ja/cross-session-messaging#how-a-session-treats-an-incoming-message) から到着するメッセージにも同じルールが適用されます。
