...
| オートモード                                                                                                | オプトインで利用可能 | [サードパーティプロバイダールール](/ja/permission-modes#enable-auto-mode-on-bedrock-agent-platform-or-foundry)に従います。`CLAUDE_CODE_ENABLE_AUTO_MODE=1` を設定し、管理ポリシー `env` ブロック経由で配信可能であり、サードパーティプロバイダーで適格なモデルのみがそれを使用できます                                                                                                                                           |
