...
Opus 4.8 は Claude Code v2.1.154 以降の高速モードのデフォルトです。v2.1.142 から v2.1.153 では、高速モードは Opus 4.7 がデフォルトです。代わりに高速モードを Opus 4.6 にピンするには、`CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE=1` を設定します。この上書きは、Opus 4.6 の高速モードが廃止されるときに削除されます。
