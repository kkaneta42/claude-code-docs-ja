...
* [パーミッションモード](/ja/permission-modes): Proactive スタイルはパーミッションモードを変更せずにオートモードをミラーリングします
* [プラグイン](/ja/plugins): スキル、フック、エージェントと一緒に出力スタイルをパッケージ化して配布します
* [設定をデバッグする](/ja/debug-your-config): 出力スタイルが有効にならない理由を診断します
