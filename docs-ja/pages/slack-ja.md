...
Slack ワークスペース管理者は、Claude アプリをワークスペースにインストールできるかどうかを制御します。その後、個別ユーザーが自分の Claude アカウントで認証して統合を使用します。
...
<CardGroup>
  <Card title="ウェブ上の Claude Code" icon="globe" href="/ja/claude-code-on-the-web">
